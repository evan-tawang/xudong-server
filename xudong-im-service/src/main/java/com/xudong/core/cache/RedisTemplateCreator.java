    ...
    public void destroy() {
        for (int i = 0; i < DATABASE_COUNT; i++) {
            ...
            if (redisTemplate != null) {
                JedisConnectionFactory JedisConnectionFactory = (org.springframework.data.redis.connection.jedis.JedisConnectionFactory) redisTemplate.getConnectionFactory();
